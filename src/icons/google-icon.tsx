...
const GoogleIcon: React.FC<GoogleIconProps> = ({
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M10.4999 20C13.0829 20 15.4299 19.0115 17.2044 17.404L14.1094 14.785C13.0717 15.5742 11.8036 16.001 10.4999 16C7.89891 16 5.69041 14.3415 4.85841 12.027L1.59741 14.5395C3.25241 17.778 6.61341 20 10.4999 20Z" fill="#4CAF50" />
